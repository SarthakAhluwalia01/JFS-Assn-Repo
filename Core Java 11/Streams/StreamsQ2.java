...
public class StreamsQ2 {
    ...
    public static void main(String[] args) {
        News news1 = new News(1, "Shruti", "Singh", "comment");
        News news2 =new News(1, "Sarthak", "Chourasia", "budget");
        News news3 = new News(2, "Tanushri", "Shrivastav", "comment");
        News news4 = new News(1, "Harsh", "Verma", "budget");
        News news5 = new News(3, "Vivek", "Kumar", "comment");
        News news6 = new News(3, "Pralanj", "Kamlesh", "budget");
        News news7 = new News(2, "Aman", "Sharma" ,"comment");
