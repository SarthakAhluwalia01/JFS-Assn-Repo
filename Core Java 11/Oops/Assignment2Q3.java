...
public  class Assignment2Q3
{
    ...
    public static void main(String[] args)
    {
        ...
        totalCashInBank.add(acc1.deposit(400));
        totalCashInBank.add(acc2.deposit(30000));
        totalCashInBank.add(acc3.deposit(5500));
        totalCashInBank.add(acc4.deposit(4500));
        totalCashInBank.add(acc3.withdraw(950));
        totalCashInBank.add(acc2.withdraw(850));
